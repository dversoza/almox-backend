...
public class AlmoxControlApplication {

	public static void main(String[] args) {
		SpringApplication.run(AlmoxControlApplication.class, args);
	}
	...
	public CorsFilter corsFilter() {
		...
		corsConfiguration.setAllowedOrigins(Arrays.asList(
				"https://catedral.herokuapp.com/",
				"http://catedral.herokuapp.com/", "http://localhost:4200"));
